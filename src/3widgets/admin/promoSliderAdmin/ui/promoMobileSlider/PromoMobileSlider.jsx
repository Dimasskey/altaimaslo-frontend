...
import "../promoDefualtSlider/promoDefualtSliderStyles.scss"
import AddSliderItem from "@/5entities/admin/addSliderItem/AddSliderItem";
...
const PromoMobileSlider = React.memo(({
                                          sliders = [],
                                          loading,
                                          mainSliderIndex,
                ...
                >
                    <div className={`sliders-list`}>
                        <div
                            ...
                            title="Добавить новый мобильный слайд"
                        >
                            <PlusImg/>
                        </div>
                        {sliders.map((slider, index) => (
                            <SortableSliderItem
                                ...
                                imageField="attachment_guid_is_mobile"
                                altText={`Мобильный слайд ${index + 1}`}
                            />
                        ))}
                    </div>
                </SortableContext>
...
export default PromoMobileSlider;